...
const STRINGS = {
  es: {
    ...
    confirmGameDelete: "¿Eliminar este grupo y sus disquetes? Sus imágenes también se borrarán.",
    gamesHeading: "Juegos",
    ...
    tagged: "Grabado",
    untagged: "Sin NFC",
    untaggedHelp: "Este disquete no se puede insertar hasta que se grabe una etiqueta NFC para él. Ponelo en la disquetera y asignale un tag desde la sección de arriba.",
    readOnly: "Solo lectura",
    readWrite: "Lectura y escritura",
    deleteAction: "Borrar",
    confirmDelete: "¿Borrar este disquete del catálogo?",
    uploading: "Subiendo...",
    uploaded: "Listo",
    stats: "{count} disquetes, {tagged} grabados",
    loadFailed: "No se pudo leer el catálogo.",
    networkError: "No se pudo conectar con RetroBox. Revisa la conexión e intenta de nuevo.",
    "unsupported-extension": "Solo se aceptan imágenes .img, .ima y .dsk.",
    "file-too-large": "La imagen supera el límite de subida.",
    "unusable-name": "Ese nombre de archivo no da un ID válido.",
    "missing-file": "No se seleccionó ningún archivo.",
    "expected-multipart": "La subida no llegó como formulario.",
    ...
    assignPlaceholder: "Elegí un disquete...",
    assignNoSelection: "Elegí un disquete de la lista antes de grabar el tag.",
    confirmReassign: "Ese tag ya es de \"{owner}\". ¿Reasignarlo a este disquete?",
    "no-tag-present": "No hay ningún disco en la disquetera.",
    "tag-already-assigned": "Ese tag ya está asignado a otro disquete.",
  ...
  en: {
    ...
    confirmGameDelete: "Delete this group and its floppies? Their images will also be deleted.",
    gamesHeading: "Games",
